package com.example.mybatis.aspectj;




import com.example.mybatis.annotation.DataSource;
import com.example.mybatis.datasource.DynamicDataSourceContextHolder;
...
public class DataSourceAspect
{
    ...
    @Pointcut("@annotation(com.example.mybatis.annotation.DataSource)"
            + "|| @within(com.example.mybatis.annotation.DataSource)")
